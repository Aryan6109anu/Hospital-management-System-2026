// src/components/modals/PharmacyStaffRegisterModal.js
import React, { useState } from "react";
import "../styles/doctorregister.css";
import api from "../../services/api";
import { showAlert } from "../common/Alert";

export default function PharmacyStaffRegisterModal({ onClose, onRegistered }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post("/admin/create/pharmacy-staff", {
  ...
  email: emailToSend,           // ✅ yaha bhejo
  username: formData.username,
  password: formData.password,

});

      showAlert("success", "Pharmacy Staff registered successfully ✅");
