...
export default function AppointmentStaffRegisterModal({ onClose, onRegistered }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post("/admin/create/appointment-staff", {
      ...
      showAlert("success", "Appointment Staff registered successfully ✅");
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-card">
        <h3>Register Appointment Staff</h3>
