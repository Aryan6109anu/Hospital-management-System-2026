...
export default function LabStaffRegisterModal({ onClose, onRegistered }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showAlert("success", "Lab Staff registered successfully ✅");
